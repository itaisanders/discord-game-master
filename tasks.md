...
## Completed
- [x] **Cinematic Vocal Recaps (The Bard)**: Implement narrative-rich audio summaries.
    ...
    - [x] **Audio**: Implemented `src/core/tts.py` using `gemini-2.5-flash-preview-tts`.
    - [x] **Commands**: Implemented `/summary` (Audio+Text) and `/voice` configuration.
