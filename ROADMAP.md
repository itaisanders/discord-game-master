...
- [x] **Cinematic Vocal Recaps**: Narrative-rich, audio-driven storytelling summarizing recent events.
    - **Goal**: Avoid robotic TTS. Create a "TV-Show Recap" vibe ("Previously, on Spire...").
    - **Tech**: Dedicated 'Scriptwriter' persona + Modular AI TTS (Gemini Native Audio).
    - **Voice Customization**: Instance-configurable voice list with styles.
    - **Commands**:
