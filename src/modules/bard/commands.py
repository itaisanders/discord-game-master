...
class BardCommands:
    ...
    def _register_commands(self):
        @self.tree.command(name="summary", description="Generate a cinematic recap of the story.")
        ...
        async def summary(interaction: discord.Interaction, scope: str = "session"):
            ...
            try:
                ...
                try:
                    ...
                    filename = f"recap_{timestamp}.wav"
                    
                    audio_data.seek(0)
                    discord_file = discord.File(fp=audio_data, filename=filename)
                ...
                await interaction.edit_original_response(content=f"❌ **The Bard's quill broke!** (Error: {e})")
